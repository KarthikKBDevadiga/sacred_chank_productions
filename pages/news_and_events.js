          ...
          <div className="px-4 mx-auto max-w-7xl">
            <div className="grid max-w-3xl grid-cols-1 gap-4 mx-auto lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-3">
              ...
              >
                ...
                />
                <div className="p-4 mx-auto mt-4 text-white bg-gray-800 rounded-md md:mt-4 ">
              ...
              >
                <div className="flex flex-col overflow-hidden bg-gray-800 rounded-md gap-">
                  <div className="flex p-4 duration-500 cursor-pointer hover:bg-gray-700">
            ...
            <div className="max-w-4xl p-4 mx-auto mt-8 text-white bg-gray-800 rounded-md ">
              <div className="max-w-5xl mx-auto text-xs text-gray-300 md:text-base">
                Admin - July 25, 2022
              </div>
              <div className="mx-auto mt-4 text-xl md:text-3xl">
              ...
              <div className="max-w-5xl mx-auto mt-2 text-sm md:text-base">
                <p className="mt-4">
                  ಕನ್ನಡ ಚಿತ್ರರಂಗ ಕಂಡ ಶ್ರೇಷ್ಠ ಗಾಯಕರಲ್ಲಿ ರಾಜೇಶ್ ಕೃಷ್ಣನ್
                  ಮುಂಚೂಣಿಯಲ್ಲಿ ನಿಲ್ಲುತ್ತಾರೆ. ಎಸ್ ಪಿ ಬಿ ಯವರು ನಮ್ಮವರೇ ಎನಿಸುವಷ್ಟು
                  ಕನ್ನಡಿಗರ ಮನೆ ಮನದಲ್ಲಿ ಬೆರೆತು ಹೋಗಿದ್ದರೂ ಅವರು ಇಡೀ ಭಾರತದ
                  ಆಸ್ತಿಯಾಗಿದ್ದರು. ಆದರೆ ಕನ್ನಡ ನೆಲದಲ್ಲಿ ಜನಿಸಿ, ಕನ್ನಡ ಸಂಗೀತ
                  ಲೋಕದಲ್ಲಿ ಅನನ್ಯ ಸಾಧನೆ ಮಾಡಿದ ರಾಜೇಶ್ ಕೃಷ್ಣನ್ ಎಂದರೆ
                  ಅತಿಶಯೋಕ್ತಿಯಾಗಲಾರದು. ಬಾಲು ಅವರ ಧ್ವನಿಯಿಂದ ಹೊರ ಬಂದ ಹಾಡುಗಳಿಗೆ
                  ಟ್ರಾಕ್ ಹಾಡುತ್ತ ತಮ್ಮ ಪ್ರತಿಭೆ ಪ್ರದರ್ಶಿಸಿದ ರಾಜೇಶ್ ಅವರು ಗೌರಿ ಗಣೇಶ
                  ಚಿತ್ರದ ಮೂಲಕ ಚೊಚ್ಚಲ ಬಾರಿಗೆ ಪೂರ್ಣ ಪ್ರಮಾಣದ ಹಿನ್ನೆಲೆ ಗಾಯಕರಾದರು.
                </p>
                <p className="mt-4">
                  ಕಳೆದ ಮೂರು ದಶಕದಿಂದ ರಾಜೇಶ್ ಅವರ ಜೇನಿನ ಕಂಠ ಸಂಗೀತಪ್ರಿಯರನ್ನು
                  ರಂಜಿಸುತ್ತಲೇ ಇದೆ. ಈ ಮೂವತ್ತು ವರ್ಷಗಳಲ್ಲಿ ಕನ್ನಡದಲ್ಲಿ 5000 ಕ್ಕೂ
                ...
                <p className="mt-4">
                  ರಾಜೇಶ್ ಕೃಷ್ಣನ್ ಅವರ ವೃತ್ತಿ ಬದುಕು ಅತ್ಯಂತ ಸವಾಲಿನಿಂದ ಕೂಡಿತ್ತು. ಎಸ್
                  ಪಿ ಬಾಲಸುಬ್ರಹ್ಮಣ್ಯಂ, ‌ಮನೋ, ಉದಿತ್ ನಾರಾಯಣ್, ಸೋನು ನಿಗಮ್, ಟಿಪ್ಪು,
                  ಶಾನ್ ಅವರಂತಹ‌ ಹೆಸರಾಂತ ‌ಗಾಯಕರಿಗೆ ಕನ್ನಡದಲ್ಲಿ ಹೆಚ್ಚೆಚ್ಚು ಅವಕಾಶಗಳು
                  ಸಿಕ್ಕಂಥ ಸಂದರ್ಭದಲ್ಲಿಯು ರಾಜೇಶ್ ತಮ್ಮ ಅಸ್ತಿತ್ವ ಉಳಿಸಿಕೊಂಡು,
                  ಬೆಳೆಸಿಕೊಂಡು ಬಂದರು. ಅವರಿಗೊಲಿದ ಸರಸ್ವತಿ ಎಂದು ಅವರ ಕೈ ಬಿಡಲಿಲ್ಲ.
                  ಒಂದು ಕಡೆ ಅದೆಷ್ಟೇ ಪೈಪೋಟಿ ಇದ್ದರೂ ಇನ್ನೊಂದೆಡೆ ತಮ್ಮ ಗಾಯನದಿಂದ ಮೋಡಿ
                  ಮಾಡುತ್ತಲೇ ಬೆಳೆದರು.
                </p>
                <p className="mt-4">
                  ಹುಚ್ಚ ಸಿನಿಮಾದ ಉಸಿರೇ ಹಾಡು ಕೇಳಿದಾಗ ಆಗುವ‌ ಖುಷಿ, ಗೂಗ್ಲಿ ಚಿತ್ರದ
                  ‘ಬಿಸಿಲ ಕುದುರೆಯೊಂದು’ ಎಂಬ ವಿಷಾದ ಕಾಡುವ ಪರಿ, ನೂರು ಜನ್ಮಕೂ ನೂರಾರು
                  ಜನ್ಮಕೂ ಎಂಬ ಪ್ರೇಮಭರಿತ ಸಾಲುಗಳಿಗೆ ಜೀವಂತಿಕೆ ನೀಡಿದ ರೀತಿ, ಸ್ನೇಹಲೋಕ
                  ಚಿತ್ರದ ಒಂದೇ ಉಸಿರಂತೆ ನಾನು ನೀನು ಹಾಡನ್ನು ಮನೋಜ್ಞವಾಗಿ ಹಾಡಿದ ಶೈಲಿ
                  ಮರೆಯಲಸಾಧ್ಯ. ಇಂತಹ ಸಾವಿರಾರು ಗೀತೆಗಳು ರಾಜೇಶ್ ಅವರ ಗಾಯನದ ಕಾರಣಕ್ಕಾಗಿ
                  ಕನ್ನಡಿಗರ ಹೃನ್ಮನದಲ್ಲಿ ಸ್ಥಾನ ಪಡೆದಿದೆ. ಅವರ ಪ್ರತಿಭೆ ಅಮೋಘ. ಆ ಜೇನಿನ‌
                  ಧ್ವನಿಗೆ ತಲೆದೂಗದವರಿಲ್ಲ, ತಲೆ ಬಾಗದವರಿಲ್ಲ.
                </p>
                <p className="mt-4">
                  ಪ್ರಣಯ, ವಿನೋದ, ವಿಷಾದ, ಜನಪದ, ಭಕ್ತಿಗೀತೆ ಸೇರಿದಂತೆ ಎಲ್ಲಾ ರೀತಿಯ
                  ಹಾಡುಗಳನ್ನು ಸರಾಗವಾಗಿ ಹಾಡಬಲ್ಲ ದೈತ್ಯ ಪ್ರತಿಭೆ ರಾಜೇಶ್ ಕೃಷ್ಣನ್. ಅವರ
                  ಸಾಧನೆ ಬಗ್ಗೆ ಪ್ರತಿ ಕನ್ನಡಿಗರಿಗೂ ಹೆಮ್ಮೆ ಮತ್ತು ಅಭಿಮಾನ ಇರಬೇಕು. ಅವರ
                  ಸಾಧನೆಗೆ ನನ್ನ ಅಕ್ಷರ ನಮನ.
                </p>
                <p className="mt-4">
                  ರಾಜೇಶ್ ಅವರ ಧ್ವನಿಯಲ್ಲಿ ಜೀವ ತಳೆದ ಅಮೇರಿಕಾ ಅಮೇರಿಕಾ ಸಿನಿಮಾದ ನೂರು
                  ಜನ್ಮಕೂ ನನ್ನಿಷ್ಟದ ಹಾಡುಗಳಲ್ಲೊಂದು.
                </p>
                <p className="mt-4">
                  ನನ್ನ ಸಾಹಿತ್ಯದ ಮೊದಲ ಗೀತೆಗೆ ಇವರು ಧ್ವನಿಯಾಗಿದ್ದು ನನ್ನ ಪಾಲಿಗೆ
                  ಎಂದಿಗೂ ಮರೆಯಲಾಗದ ಖುಷಿ.
